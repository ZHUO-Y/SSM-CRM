...
(function (e) {
    ...
    var b = {
        init: function (g) {
            ...
            return this.each(function () {
                ...
                var y = h.attr("id"), r = c(C.nav_list_id_prefix, y),
                    k = c(C.nav_top_id_prefix, y), A = c(C.nav_prev_id_prefix, y),
                    q = c(C.nav_item_id_prefix, y) + "_", o = c(C.nav_next_id_prefix, y),
                    p = c(C.nav_last_id_prefix, y), x = c(C.nav_goto_page_id_prefix, y),
                    B = c(C.nav_rows_per_page_id_prefix, y),
                    m = c(C.nav_rows_info_id_prefix, y), w = "", l, i, u, s, z, t, n, j,
                    D;
    ...
    var f = function (F, k, g, J, u) {
        var I = e("#" + F), B = b.getAllOptions.call(I),
            t = c(B.nav_item_id_prefix, F) + "_";
        if (J) {
            var l = c(B.nav_list_id_prefix, F), h = c(B.nav_top_id_prefix, F),
                H = c(B.nav_prev_id_prefix, F), m = c(B.nav_next_id_prefix, F),
                r = c(B.nav_last_id_prefix, F), v = e("#" + l), G = "",
                z = parseInt(B.currentPage), x, E, L, q, C, y = "",
                w = "javascript:void(0);";
